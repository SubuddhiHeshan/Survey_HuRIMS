...
class admin_dash_model extends CI_Model
{
    ...
    {
//        select (select count(*) from employee e join designation_history dh on e.id = dh.employee_id and dh.from_date = (select max(from_date) from designation_history where designation_history.employee_id = e.id and designation_history.designation_id=58) where e.emp_status=1)/
//        (select count(*) from employee where emp_status=1) * 100 as msoTot;

        $this->db->select("(select count(*) from employee e join designation_history dh on e.id = dh.employee_id and dh.from_date = (select max(from_date) from designation_history where designation_history.employee_id = e.id and designation_history.designation_id=58) where e.emp_status=1)/
        (select count(*) from employee where emp_status=1) * 100 as msoTot");
    ...
    {
        $this->db->select("(select count(*) from employee e join designation_history dh on e.id = dh.employee_id and dh.from_date = (select max(from_date) from designation_history where designation_history.employee_id = e.id and designation_history.designation_id=62) where e.emp_status=1)/
    ...
    {
        $this->db->select("(select count(*) from employee e join designation_history dh on e.id = dh.employee_id and dh.from_date = (select max(from_date) from designation_history where designation_history.employee_id = e.id and designation_history.designation_id=7) where e.emp_status=1)/
