    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter">
                                   <?php echo $counter1->snrMtoCount; ?>
                               </span></h2>
                        <p>Total No of Snr.MTO </p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter2->mtoCount; ?></span></h2>
                        <p>Total No of MTO</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter3->ptoCount; ?></span></h2>
                        <p>Total No PTO </p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter4->deptAsstCount; ?></span></h2>
                        <p>Total No of Dept. Assistant </p>
                    </div>
                ...
                <div class="sale-statistic-inner notika-shadow mg-tb-30">
                    <div class="curved-inner-pro">
                        <div class="curved-ctn">
                            <h2>EMPLOYEES IN DEPARTMENT SERVICE STATISTICS</h2>
                            <p>Department Officers assigned under office type <b>COMPARISON</b> with the department</p>
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        var barchart1 = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Department Service Employees Assigned',
                    data: [<?php echo $barSgo->deptSgoTotCount;?>, <?php echo $barProv->deptProvTotCount;?>, <?php echo $barDist->deptDistTotCount;?>, <?php echo $barDiv->deptDivTotCount;?>,<?php echo $barIsm->deptIsmTotCount;?>],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgb(50,205,50, 0.2)',
                        'rgba(255, 206, 86, 0.2)',
