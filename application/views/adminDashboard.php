...
<head>
    <title>Dashboard | Survey - Human Resorce Management System</title>
...
<div class="notika-status-area">
    <div class="container">
        <!--Start Display Flash Message Area-->


        <!--End Display Flash Message Area-->
...
<!-- End Main Body area Sec1-->

<!-- Start Main Body area Sec2-->
