    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter">
                                   <?php echo $counter1->sfaSpCount; ?>
                               </span></h2>
                        <p>Total No of SFA (Special)</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter2->sfa1Count; ?></span></h2>
                        <p>Total No of SFA (I)</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter3->sfa2Count; ?></span></h2>
                        <p>Total No of SFA (II)</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter4->sfa3Count; ?></span></h2>
                        <p>Total No of SFA (III)</p>
                    </div>
                ...
                <div class="sale-statistic-inner notika-shadow mg-tb-30">
                    <div class="curved-inner-pro">
                        <div class="curved-ctn">
                            <h2>EMPLOYEES IN SURVEY FIELD ASSISTANT (SFA) SERVICE STATISTICS</h2>
                            <p>SFA Officers assigned under office type <b>COMPARISON</b> with the department</p>
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        var barchart1 = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'SFA Service Employees Assigned',
                    data: [<?php echo $barSgo->sfaSgoTotCount;?>, <?php echo $barProv->sfaProvTotCount;?>, <?php echo $barDist->sfaDistTotCount;?>, <?php echo $barDiv->sfaDivTotCount;?>,<?php echo $barIsm->sfaIsmTotCount;?>],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgb(50,205,50, 0.2)',
                        'rgba(255, 206, 86, 0.2)',
