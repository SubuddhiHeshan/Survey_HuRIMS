    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter">
                                   <?php echo $counter1->msoCount; ?>
                               </span></h2>
                        <p>Total No of MSO Officers</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter2->doCount; ?></span></h2>
                        <p>Total No of DO</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter3->kksCount; ?></span></h2>
                        <p>Total No of KKS</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                    <div class="website-traffic-ctn">
                        <h2><span class="counter"><?php echo $counter4->driverCount; ?></span></h2>
                        <p>Total No of Drivers</p>
                    </div>
                ...
                <div class="sale-statistic-inner notika-shadow mg-tb-30">
                    <div class="curved-inner-pro">
                        <div class="curved-ctn">
                            <h2>EMPLOYEES IN COMBINE SERVICE STATISTICS</h2>
                            <p>Combine Officers assigned under office type <b>COMPARISON</b> with the department</p>
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        var barchart1 = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Combine Service Employees Assigned',
                    data: [<?php echo $barSgo->ComSgoTotCount;?>, <?php echo $barProv->ComProvTotCount;?>, <?php echo $barDist->ComDistTotCount;?>, <?php echo $barDiv->ComDivTotCount;?>,<?php echo $barIsm->ComIsmTotCount;?>],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgb(50,205,50, 0.2)',
                        'rgba(255, 206, 86, 0.2)',
