                        ...
                        <div class="contact-list">
                            <div class="contact-win">
                                <div class="contact-img">
                                    ...
                                    if ($maindata->image_id == 0 || $maindata->image_id == null) {

                                        $usericon = $maindata->title;
                                        switch ($usericon) {
                                            case 'Mr.':
                                                $usericon = "male.png";
                                                break;
                            ...
                            <div class="contact-ctn">
                                <div class="contact-ad-hd">
                                    <h2>
                                        <?php if ($maindata->title != null) {
                                            echo $maindata->title . ' ';
                                        }

                                        if ($maindata->middlename != null) {
                                            echo $maindata->middlename . ' ';
                                        }

                                        if ($maindata->lastname != null) {
                                            echo $maindata->lastname;
                                        }
                                        ?>
                                    </h2>
                                    <p class="ctn-ads">
                                        <?php if ($maindata->desig != null) {
                                            echo $maindata->desig;
                                        } ?>
                                    </p>
                                </div>
                                <i class="notika-icon notika-phone"> </i><span><b><?php if ($maindata->mobile != null) {
                                            echo $maindata->mobile;
                                        } else {
                                            echo "Not Updated";
                                        } ?></b></span></br>
                                <i class="notika-icon notika-phone"> </i><span><b><?php if ($maindata->tel != null) {
                                            echo $maindata->tel;
                                        } else {
                                            echo "Not Updated";
                                        } ?></b></span></br>
                                <i class="notika-icon notika-mail"> </i><span><b><?php if ($maindata->email != null) {
                                            echo $maindata->email;
                                        } else {
                                            echo "Not Updated";
                                        } ?></b></span>
                                ...
                                <table border="0" style="margin-left: 100px; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left; vertical-align: center; padding-left: 30px; ">
                                            <span><?php echo $maindata->id; ?></span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 15px; padding-left: 30px;">
                                            <h4>
                                                <?php if ($maindata->initialname != null) {
                                                    echo $maindata->initialname;
                                                } else { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 15px; padding-left: 30px;">
                                            <p><?php if ($maindata->name_sinhala != null) {
                                                    echo $maindata->name_sinhala;
                                                } else { ?>
                                                    <i><?php echo "NOT UPDATED"; ?></i>
                                                <?php } ?>
                                            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-left: 30px;">
                                                    <span><?php if ($maindata->name_tamil != null) {
                                                            echo $maindata->name_tamil;
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 25px; padding-left: 30px;">
                                                    <span><?php if ($maindata->appoinment_lett_no != null) {
                                                            echo $maindata->appoinment_lett_no;
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-left: 30px; padding-top: 15px;">
                                            <h4><?php if ($maindata->branchname != null) {
                                                    echo $maindata->branchname;
                                                } else { ?>
                                                    <i>NOT UPDATED </i>
                                                <?php } ?>
                                            </h4>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 5px; padding-left: 30px;">
                                                    <span><?php if ($maindata->gender != null) {
                                                            echo $maindata->gender;
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 5px; padding-left: 30px;">
                                                    <span><?php if ($maindata->cstatus != null) {
                                                            echo $maindata->cstatus;
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 10px; padding-left: 30px;">
                                            <p><?php if ($maindata->wop_no != null) {
                                                    echo $maindata->wop_no;
                                                } else { ?>
                                                    <i><?php echo "NOT UPDATED"; ?></i>
                                                <?php } ?>
                                            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 5px; padding-left: 30px;">
                                                    <span><?php if ($maindata->permanent_date == null || $maindata->permanent_date == "0000-00-00") { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } else {
                                                            echo $maindata->permanent_date;
                                                        } ?>
                                                    </span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 5px; padding-left: 30px;">
                                                    <span><?php if ($maindata->appointment_date != null) {
                                                            echo $maindata->appointment_date;
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 5px; padding-left: 30px;">
                                                    <span><?php if ($maindata->increment_date != null) {
                                                            echo $maindata->increment_date;
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 20px; padding-left: 30px;">
                                            <h4><?php if ($maindata->disname != null) {
                                                    echo $maindata->disname;
                                                } else { ?>
                                                    <i><?php echo "NOT UPDATED"; ?></i>
                                                <?php } ?>
                                            </h4>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 10px; padding-left: 30px;">
                                                    <span><?php if ($maindata->privateaddress != null) {
                                                            echo $maindata->privateaddress . ' ';
                                                        }
                                                        if ($maindata->privateaddress2 != null) {
                                                            echo $maindata->privateaddress2 . ' ';
                                                        }
                                                        if ($maindata->privateaddress3 != null) {
                                                            echo $maindata->privateaddress3;
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left; vertical-align: center; padding-top: 10px; padding-left: 30px;">
                                                    <span><?php if ($maindata->present_address != null) {
                                                            echo $maindata->present_address . ' ';
                                                        } else { ?>
                                                            <i><?php echo "NOT UPDATED"; ?></i>
                                                        <?php } ?>
                                                    </span>
